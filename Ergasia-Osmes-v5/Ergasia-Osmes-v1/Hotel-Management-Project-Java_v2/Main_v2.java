...
class Doubleroom extends Singleroom implements Serializable {
    ...
    private Doubleroom(Builder builder) {
        super(builder.name, builder.contact, builder.gender);
        this.name2 = builder.name2;
        this.contact2 = builder.contact2;
        this.gender2 = builder.gender2;
    }
    ...
    public static class Builder {
        ...
        public Builder setContact2(String contact2) {
            this.contact2 = contact2;
            return this;
        }

        public Builder setGender2(String gender2) {
...
static int countAvailableRooms(Object[] rooms) {
	...
	static void availability(int i) {
		    ...
		    switch (i) {
		        case 1:
		            availableRooms = countAvailableRooms(Hotel.hotel_ob.luxury_doublerrom);
		            break;
		        case 2:
		            availableRooms = countAvailableRooms(Hotel.hotel_ob.deluxe_doublerrom);
		            break;
		        case 3:
		            availableRooms = countAvailableRooms(Hotel.hotel_ob.luxury_singleerrom);
		            break;
		        case 4:
		            availableRooms = countAvailableRooms(Hotel.hotel_ob.deluxe_singleerrom);
		            break;
		        default:
		            System.out.println("Enter valid option");
		            return;
...
static void bookroom(int roomTypeIndex, Object[] roomArray, int baseNumber) {
    ...
    try {
        ...
        Hotel.CustDetails(roomTypeIndex, rn);
    } catch (Exception e) {
...
static void bookroom(int i) {
    ...
    switch (i) {
        case 1:
            roomDetails = Hotel.hotel_ob.luxury_doublerrom;
            baseNumber = 1;
            break;
        case 2:
            roomDetails = Hotel.hotel_ob.deluxe_doublerrom;
            baseNumber = 11;
            break;
        case 3:
            roomDetails = Hotel.hotel_ob.luxury_singleerrom;
            baseNumber = 31;
            break;
        case 4:
            roomDetails = Hotel.hotel_ob.deluxe_singleerrom;
            baseNumber = 41;
            break;
        default:
            System.out.println("Enter valid option");
...
class Hotel
{
    ...
    static void CustDetails(int i, int rn) {
        ...
        if (i < 3) {
            ...
            Doubleroom room = new Doubleroom.Builder()
                .setName(name)
                .setContact(contact)
                .setGender(gender)
                .setName2(name2)
            ...
            if (i == 1) {
                hotel_ob.luxury_doublerrom[rn] = room;
            } else {
                hotel_ob.deluxe_doublerrom[rn] = room;
            }
        } else {
            Singleroom room = new Singleroom(name, contact, gender);
            if (i == 3) {
                hotel_ob.luxury_singleerrom[rn] = room;
            } else {
                hotel_ob.deluxe_singleerrom[rn] = room;
            }
        }
    }
